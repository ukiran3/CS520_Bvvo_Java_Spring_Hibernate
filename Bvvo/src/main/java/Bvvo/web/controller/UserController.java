...
public class UserController 
{
	...
	@RequestMapping(value = "/users/Signup.html")
	...
	@RequestMapping(value = "/users/helloS.html", method = RequestMethod.POST)
	public String helloS(HttpServletRequest request)
	{
		int revId = Integer.valueOf(request.getParameter("revId"));
		Review rev = userDao.getReviewByIdForDelete(revId);
		rev.setId(revId);
		rev.setKnowledge(Integer.valueOf(request.getParameter("knowledge")));
		rev.setService(Integer.valueOf(request.getParameter("service")));
		rev.setOverall(Integer.valueOf(request.getParameter("overall")));
		userDao.saveReview(rev);
