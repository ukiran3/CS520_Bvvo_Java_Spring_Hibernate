...
<table align="center" border="1" cellpadding="2" cellspacing="2" width="60%">
  <tbody>
    <tr>
      ...
      <td valign="top"><form:input style="width: 100%;" path = "email"></form:input><br></td>
    </tr>
    <tr>
 ...
 <!--    <tr>
    ...
    <tr>
      ...
      <td valign="top"><form:input style="width: 100%;" path = "fName" type="text"></form:input><br></td>
    </tr>
    <tr>
      <td valign="top">Last Name*:<br></td>
      <td valign="top"><form:input style="width: 100%;" path = "lName"></form:input><br></td>
    </tr>
    <tr>
    ...
    <tr>
    <td>City*:<form:input path = 'city'></form:input></td>
    <td>State*:<form:input size = '20' path = 'state'></form:input></td>
    </tr>
    <tr>
    <td>Zip*:</td>
    <td><form:input path = 'zip'></form:input></td>
    </tr>
    <c:choose>
    ...
    <td>(yyyy)<form:input path = "year"></form:input></td>
