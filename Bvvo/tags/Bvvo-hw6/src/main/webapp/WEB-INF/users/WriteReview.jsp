...
<tr>
    ...
    <td><h3>Knowledge*:</h3><form:radiobutton path = "knowledge" value = "1"></form:radiobutton><form:radiobutton path = "knowledge" value = "2"></form:radiobutton><form:radiobutton path = "knowledge" value = "3" checked='true'></form:radiobutton><form:radiobutton path = "knowledge" value = "4"></form:radiobutton><form:radiobutton path = "knowledge" value = "5"></form:radiobutton>
